...
public class Employee {
    ...
    public String toString() {
        return String.format("ID: %s \t|\t ИНН: %s \t|\t Дата рожд.: %s \t|\t Имя: %s \t|\t Отчество: %s \t|\t Фамилия: %s \t|\t Телефон: %s \t|\t Email: %s \t|\t Категория прав: %s",
                this.id_employee, this.inn, this.date_of_birth, this.first_name, this.middle_name, this.last_name,
                this.phone, this.email, this.driver_license_category);
    }
}
