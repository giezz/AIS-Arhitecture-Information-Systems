...
public class JDBCHandler {
    ...
    /* TODO: Переделать под паттрен DAO */
...
//    public ObservableList<EmployeeEmployeePosition> getEEP() {
//        String selectSQL = """
//                SELECT e.id_employee, e.first_name, e.last_name, ep.name, ep.salary FROM employees AS e
...
//
//            ObservableList<EmployeeEmployeePosition> eepObservableList = FXCollections.observableArrayList();
//            while (resultSet.next()) {
//                eepObservableList.add(new EmployeeEmployeePosition(resultSet.getInt(1),
...
//    }
    ...
    private ObservableList<Employee> handleQuery(String sql) {
        try (Statement statement = this.connection.createStatement();
            ...
            while (resultSet.next()) {
                employeeFilteredObservableList.add(
                        new Employee(
                                resultSet.getInt(1),
                                resultSet.getString(2),
                                resultSet.getString(3),
